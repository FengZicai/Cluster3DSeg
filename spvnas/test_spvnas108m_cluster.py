...
def main() -> None:
    ...
    parser.add_argument('--run-dir', default='.../You/downloaded/model file/spvnas108m_cluster', help='run directory')
    parser.add_argument('--name', type=str, help='model name')
    args, opts = parser.parse_known_args()
    opts = ['--run-dir','.../You/downloaded/model file/spvnas108m_cluster','--name','spvnas']
    ...
    # model = builder_cluster.make_model().to(pytorch_device)
    ...
    pre_weight = torch.load(".../You/downloaded/model file/spvnas108m_cluster/checkpoints/step-87015.pt", map_location='cuda:'+ str(gpu))['model']
    part_load = {}
    match_size = 0
    nomatch_size = 0
    ...
    for feed_dict in tqdm(dataflow['test'], desc='eval'):
        ...
        new_save_dir = './out/spvnas108m_cluster/sequences/' +dir2.replace('velodyne','predictions')[:-3]+'label'
